      ...
      <div className="about-container">
        ...
        <div className="about-details">
          ...
          <p className="about-desc">
            ...
            With 6 months of experience as a Red Team Analyst at Cybersec in
            Gurugram, I specialize in web security and penetration testing. I
            excel in bug hunting, vulnerability scanning, and security
            documentation, leveraging my skills to strengthen corporate
            security. I am actively engaged in bug bounty programs to further
            enhance my expertise in identifying and mitigating security
            vulnerabilities. <br />
            Outside of my professional pursuits, I am passionate about
            slow-paced and art films, immersing myself in their unique
